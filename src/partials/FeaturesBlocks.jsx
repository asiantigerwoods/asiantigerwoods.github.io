      ...
      <div id="preview" className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Coming in October 2023</h2>
            <p className="text-xl text-gray-400">
              Enhance the way you work out.
            </p>
          </div>
          ...
          >
            ...
            >
              <svg
                className="w-16 h-16 mb-4 grow-on-hover"
                viewBox="0 0 64 64"
              ...
              <p className="text-lg text-gray-400 text-center">
                Build and save your routine within the app using an intuitive
                template. No more spreadsheets, note apps, or notebooks.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Get matched with a routine that helps you acheive your goals.
                Searching for routines online is a thing of the past.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Collaborate with your friends to create and share routines. Show
                off your progress and hold your friends accountable with
                streaks.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M527 976v-60q35-6 69-19.5t66-37.5l43 44q-40 30-85 48t-93 25Zm-90 0q-137-21-226-122t-89-241q0-75 28-140.5T227 358q49-49 114.5-77T482 253h20l-79-79 44-44 153 153-153 153-44-44 79-79h-20q-127 0-213.5 86.5T182 613q0 117 72.5 199.5T437 916v60Zm331-136-44-44q23-30 36.5-65t18.5-73h61q-7 51-25.5 97.5T768 840Zm72-272h-61q-5-35-18.5-70T724 430l44-43q29 40 47 85.5t25 95.5Z"
                    fill="white"
                  />
                </svg>
              </svg>
              ...
              <p className="text-lg text-gray-400 text-center">
                Streamline progression effortlessly. AI will optimize lifting
                weight between days and calculate progressive overload based on
                prior lifts.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  <path
                    d="M559 959q-18 18-43.5 18T472 959L97 584q-10-10-13.5-21T80 540V236q0-26 17-43t43-17h304q12 0 24 3.5t22 13.5l373 373q19 19 19 44.5T863 655L559 959Zm-41-41 304-304-378-378H140v304l378 378ZM245 392q21 0 36.5-15.5T297 340q0-21-15.5-36.5T245 288q-21 0-36.5 15.5T193 340q0 21 15.5 36.5T245 392ZM140 236Z"
                    fill="white"
                  />
                </svg>
              </svg>
              ...
              <p className="text-lg text-gray-400 text-center">
                One-stop shop for trainers, bodybuilders, and influencers to
                host routines. No need to upkeep a personal website and handle
                payments from clients anymore.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Say goodbye to price-gouging exercise apps. Obliq has no ads, no
                hidden fees, no required subscriptions, and no limits - all
