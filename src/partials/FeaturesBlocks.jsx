        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-16 h-16 mb-4 grow-on-hover" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-lg text-gray-400 text-center">Build and save your routine within the app using an intuitive template. No more spreadsheets, note apps, or notebooks.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">Get matched with a routine that helps you acheive your goals. Searching for routines online is a thing of the past.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">Collaborate with your friends to create and share routines. Show off your progress and hold your friends accountable with streaks.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">One-stop shop for trainers, bodybuilders, and influencers to host routines. No need to upkeep a personal website and handle payments from clients anymore.</p>
            </div>
