      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            {/* 1st checkpoint */}
            <Tilt glareReverse glareEnable glareMaxOpacity={0.4} className='h-full' tiltMaxAngleX={12} tiltMaxAngleY={12}>
            ...
            <Tilt glareReverse glareEnable glareMaxOpacity={0.4} className='h-full' tiltMaxAngleX={12} tiltMaxAngleY={12}>
              <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
                ...
                <blockquote className="text-lg text-gray-400 grow">Set up your routines to require payment for access, effectively monetizing your services. The tier-based payment system will allow for additional perks to customers based on the amount paid.</blockquote>
                <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
