        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link to="/" className="inline-block" aria-label="Cruip">
                  <svg className="w-8 h-8 fill-current text-green-200" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link to="https://github.com/ObliqApp" className="flex justify-center items-center text-green-200 bg-gray-800 hover:text-gray-100 hover:bg-green-200 rounded-full transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* <li className="ml-4">
                <Link to="#" className="flex justify-center items-center text-green-200 bg-gray-800 hover:text-gray-100 hover:bg-green-200 rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link to="https://www.instagram.com/obliq.app/" className="flex justify-center items-center text-green-200 bg-gray-800 hover:text-gray-100 hover:bg-green-200 rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link to="https://www.linkedin.com/company/obliq-llc/" className="flex justify-center items-center text-green-200 bg-gray-800 hover:text-gray-100 hover:bg-green-200 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; obliq.app. All rights reserved.</div>
